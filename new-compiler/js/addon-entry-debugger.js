...
/* harmony default export */ __webpack_exports__["default"] = (async function (_ref) {
  ...
  const createBlockPreview = (targetId, blockId) => {
    ...
    let shape;
    let color;
    if (block.opcode === "data_variable" || block.opcode === "data_listcontents" || block.opcode === "data_listarraycontents" || block.opcode === "argument_reporter_string_number" || block.opcode === "argument_reporter_boolean") {
